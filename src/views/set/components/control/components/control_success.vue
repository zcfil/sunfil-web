<template>
  <div id="ControlSuccess" class="container">
    <!-- 修改Control -->
    <div class="topProd">
      <h4>修改Control</h4>

      <!--  如果有需要，您可以通过智能合约修改节点的Control地址。 -->
      <p>如果有需要，您可以通过智能合约修改节点的Control地址。</p>
    </div>
    ...
    <div class="bottomCard">
      ...
      <div class="cardInfo">
        <div class="contentBox">
          ...
          <!-- 修改成功 -->
          <div class="success">
            <span> <SvgIcon name="controlSuccess"></SvgIcon></span>
            <!-- Control修改成功 -->
            <span>{{ $t('Control_succes') }}</span>
          </div>

          <!-- 新的Control已设置成功。 -->
          <div class="welcome">{{ $t('Control_been') }}</div>
        </div>
